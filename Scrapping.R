...
Sys.setenv(ATLAS_COLLECTION = Sys.getenv("ATLAS_COLLECTION"))
Sys.setenv(ATLAS_DB = Sys.getenv("ATLAS_DB"))
Sys.setenv(ATLAS_URL = Sys.getenv("ATLAS_URL"))
...
base_url <- "https://sinta.kemdikbud.go.id/authors?page=3"
